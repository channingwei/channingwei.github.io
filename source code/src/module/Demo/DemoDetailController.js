...
(function () {
   'use strict';
   xrmApp.controller("TestController", ['$scope', '$state', 'rt', '$ionicScrollDelegate', 'DemoService', TestController]);
   function TestController($scope, $state, rt, $ionicScrollDelegate, DemoService) {
